...
const appCss = "/starry-sketchbook-glow/assets/styles-CJHp6NKp.css";
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "zh-CN", className: "dark", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("head", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeadContent, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "dark bg-black text-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-md min-h-screen relative bg-background overflow-hidden shadow-[0_0_60px_rgba(0,0,0,0.8)]", children }),
...
const $$splitComponentImporter$b = () => import("./trail-detail-LxAU6eDx.js");
const Route$b = createFileRoute("/trail-detail")({
  head: () => ({
    meta: [{
      title: "星轨详情 · 同频未署名"
    }]
...
const $$splitComponentImporter$a = () => import("./trail-D4y4NgvP.js");
const Route$a = createFileRoute("/trail")({
  head: () => ({
    meta: [{
      title: "星轨 · 同频未署名"
    }]
...
const $$splitComponentImporter$9 = () => import("./similar-DwZtpr_b.js");
const Route$9 = createFileRoute("/similar")({
  head: () => ({
    meta: [{
      title: "相似留言 · 同频未署名"
    }]
...
const $$splitComponentImporter$8 = () => import("./shiguang-DDdOWuFX.js");
const Route$8 = createFileRoute("/shiguang")({
  head: () => ({
    meta: [{
      title: "拾光 · 同频未署名"
    }]
  ...
  validateSearch: (search) => ({
    stage: search.stage || "seeking",
    starNumber: search.starNumber || void 0,
    message: search.message || void 0,
    liked: search.liked || void 0
  })
});
const $$splitComponentImporter$7 = () => import("./message-BXvhBkRh.js");
const Route$7 = createFileRoute("/message")({
  head: () => ({
    meta: [{
      title: "留言 · 同频未署名"
    }]
  ...
  validateSearch: (search) => ({
    star: search.star || "碎星#100",
    content: search.content || "这是一条示例消息内容",
    tags: search.tags || "",
    from: search.from || "shiguang",
    liked: search.liked || void 0
  })
});
...
const $$splitComponentImporter$6 = () => import("./keeper-BuS-yYis.js");
const Route$6 = createFileRoute("/keeper")({
  head: () => ({
    meta: [{
      title: "守夜人 · 同频未署名"
    }]
...
const $$splitComponentImporter$5 = () => import("./glimmer-new-B3f1AegO.js");
const Route$5 = createFileRoute("/glimmer-new")({
  head: () => ({
    meta: [{
      title: "拾光 · 同频未署名"
    }]
...
const $$splitComponentImporter$4 = () => import("./glimmer-fixed-B3f1AegO.js");
const Route$4 = createFileRoute("/glimmer-fixed")({
  head: () => ({
    meta: [{
      title: "拾光 · 同频未署名"
    }]
...
const $$splitComponentImporter$3 = () => import("./glimmer-BHY41XtZ.js");
const Route$3 = createFileRoute("/glimmer")({
  head: () => ({
    meta: [{
      title: "拾光 · 同频未署名"
    }]
...
const $$splitComponentImporter$2 = () => import("./echo-BLv-ZRRx.js");
const Route$2 = createFileRoute("/echo")({
  head: () => ({
    meta: [{
      title: "回声 · 同频未署名"
    }]
...
const $$splitComponentImporter$1 = () => import("./carve-C88Ip8a5.js");
const Route$1 = createFileRoute("/carve")({
  head: () => ({
    meta: [{
      title: "刻录 · 同频未署名"
    }]
...
const $$splitComponentImporter = () => import("./index-4Yp7tO6s.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "有些共鸣，不需要名字。一片随身携带的极夜星空。"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TrailDetailRoute = Route$b.update({
  id: "/trail-detail",
  path: "/trail-detail",
  getParentRoute: () => Route$c
});
const TrailRoute = Route$a.update({
  id: "/trail",
  path: "/trail",
  getParentRoute: () => Route$c
});
const SimilarRoute = Route$9.update({
  id: "/similar",
  path: "/similar",
  getParentRoute: () => Route$c
});
const ShiguangRoute = Route$8.update({
  id: "/shiguang",
  path: "/shiguang",
  getParentRoute: () => Route$c
});
const MessageRoute = Route$7.update({
  id: "/message",
  path: "/message",
  getParentRoute: () => Route$c
});
const KeeperRoute = Route$6.update({
  id: "/keeper",
  path: "/keeper",
  getParentRoute: () => Route$c
});
const GlimmerNewRoute = Route$5.update({
  id: "/glimmer-new",
  path: "/glimmer-new",
  getParentRoute: () => Route$c
});
const GlimmerFixedRoute = Route$4.update({
  id: "/glimmer-fixed",
  path: "/glimmer-fixed",
  getParentRoute: () => Route$c
});
const GlimmerRoute = Route$3.update({
  id: "/glimmer",
  path: "/glimmer",
  getParentRoute: () => Route$c
});
const EchoRoute = Route$2.update({
  id: "/echo",
  path: "/echo",
  getParentRoute: () => Route$c
});
const CarveRoute = Route$1.update({
  id: "/carve",
  path: "/carve",
  getParentRoute: () => Route$c
});
