...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-tRkf1rFI.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-vqVZ2fwF.js").then((n2) => n2.d),
...
var ROUTER_BASEPATH = "starry-sketchbook-glow";
var SERVER_FN_BASE = "/starry-sketchbook-glow/_serverFn/";
