import { r as reactExports, M as useRouter, U as jsxRuntimeExports } from "./worker-entry-DQRps7mk.js";
import { a as Route, L as Link } from "./router-vqVZ2fwF.js";
...
function Shiguang() {
  const {
    stage: initialStage,
    starNumber: initialStarNumber,
    message: initialMessage,
    liked: initialLiked
  } = Route.useSearch();
  const [stage, setStage] = reactExports.useState(initialStage || "seeking");
  ...
  const [message, setMessage] = reactExports.useState(() => selectedData.content);
  const [showMessage, setShowMessage] = reactExports.useState(initialStage === "blooming");
  const [typewriterText, setTypewriterText] = reactExports.useState("");
  const [showStar, setShowStar] = reactExports.useState(initialStage === "blooming");
  const [showArrow, setShowArrow] = reactExports.useState(initialStage === "blooming");
  const [isLiked, setIsLiked] = reactExports.useState(() => {
    if (initialLiked === "true") return true;
    if (initialLiked === "false") return false;
    return false;
  });
  const [successText, setSuccessText] = reactExports.useState("");
  const [starNumber, setStarNumber] = reactExports.useState(() => initialStarNumber ? parseInt(initialStarNumber) : Math.floor(Math.random() * 1e3));
  const [minutesAgo, setMinutesAgo] = reactExports.useState(() => Math.floor(Math.random() * 60) + 1);
  const [tags, setTags] = reactExports.useState(() => selectedData.tags);
  ...
  const handleReCatch = () => {
    ...
    const newStarNumber = Math.floor(Math.random() * 1e3);
  ...
  const [showHeaderInfo, setShowHeaderInfo] = reactExports.useState(initialStage === "blooming");
  const [visibleTags, setVisibleTags] = reactExports.useState(initialStage === "blooming" ? [0, 1, 2] : []);
  const [displayMessage, setDisplayMessage] = reactExports.useState(initialStage === "blooming" ? message : "");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { title: "拾光", subtitle: "看看来自其他碎星的记录", children: [
    stage === "seeking" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-20 transition-opacity duration-1000 ease-in-out", children: [
      [...Array(3)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, className: "pointer-events-none absolute w-24 h-[1px] bg-gradient-to-r from-transparent via-white to-transparent", style: {
        top: "0",
        left: "0",
        animation: "meteor-short 3s linear",
        animationDelay: `${i * 1.5}s`
      } }, i)),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 left-1/2 -translate-x-1/2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg tracking-[0.3em] text-white/80 font-cn", children: [
        typewriterText,
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-pulse", children: "|" })
      ] }) })
    ] }),
    stage === "touching" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-20 transition-opacity duration-1000 ease-in-out", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/5 left-1/2 -translate-x-1/2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg tracking-[0.3em] text-white/80 font-cn", children: [
        successText,
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-pulse", children: "|" })
      ] }) }),
      showStar && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute w-4 h-4 bg-white rounded-full cursor-pointer hover:scale-110 transition-transform", style: {
        left: "50%",
        top: "calc(20% + 140px)",
        ...
        setStage("blooming");
        setTimeout(() => setShowHeaderInfo(true), 1e3);
        setTimeout(() => {
      ...
      showStar && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute border border-white/20 rounded-full pointer-events-none", style: {
        left: "50%",
        top: "calc(20% + 140px)",
        width: "100px",
        height: "100px",
      ...
      showArrow && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 -translate-x-1/2 text-white text-2xl", style: {
        top: "calc(20% + 100px)",
        animation: "float 2s ease-in-out infinite"
      }, children: "↓" })
    ] }),
    stage === "blooming" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-20 transition-opacity duration-1000 ease-in-out", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute w-80 max-w-[90vw] bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-6", style: {
        left: "50%",
        top: "calc(20% + 70px)",
        transform: "translate(-50%, -50%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 left-4 text-white/60 font-cn text-sm", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 right-4 text-white/60 font-cn text-sm", style: {
          opacity: showHeaderInfo ? 1 : 0,
          transition: "opacity 1s ease-in"
        }, children: [
          minutesAgo,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 overflow-y-auto", style: {
          maxHeight: "300px",
          // 内容区域最大高度
          scrollbarWidth: "thin",
          scrollbarColor: "rgba(255, 255, 255, 0.3) rgba(255, 255, 255, 0.1)"
        }, children: displayMessage && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] leading-relaxed text-white font-cn", style: {
          animation: "fadeIn 1s ease-in forwards"
        }, children: message }) }),
        tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-4", children: tags.map((tag, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-white/10 text-white/80 rounded-full px-3 py-1 text-xs border border-white/30", style: {
      ...
      displayMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-4", style: {
        top: "calc(20% + 70px + 230px)"
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleLikeToggle, className: "text-white hover:text-white/80 transition-colors duration-200 text-base font-cn", children: [
          "同频",
          isLiked ? "❤️" : "🤍"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/message", search: {
          star: `碎星#${starNumber}`,
          content: message,
          tags: tags.join(","),
          from: "shiguang",
          liked: isLiked.toString()
        }, className: "text-white hover:text-white/80 transition-colors duration-200 text-base font-cn", children: "留言→" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleReCatch, className: "text-white hover:text-white/80 transition-colors duration-200 text-base font-cn", children: "←再摘一颗" })
      ] })
    ] })
  ] });
}
export {
  Shiguang as component
};
