...
// 生成2024.09.20的随机时刻
export const generateRandomTime0920 = () => {
  const hour = String(Math.floor(Math.random() * 24)).padStart(2, '0');
  const minute = String(Math.floor(Math.random() * 60)).padStart(2, '0');
...
// 生成2024.11.07的随机时刻
export const generateRandomTime1107 = () => {
  const hour = String(Math.floor(Math.random() * 24)).padStart(2, '0');
  const minute = String(Math.floor(Math.random() * 60)).padStart(2, '0');
...
// 生成2025.04.16的随机时刻
export const generateRandomTime0416 = () => {
  const hour = String(Math.floor(Math.random() * 24)).padStart(2, '0');
  const minute = String(Math.floor(Math.random() * 60)).padStart(2, '0');
...
// 生成2025.06.16的随机时刻
export const generateRandomTime0616 = () => {
  const hour = String(Math.floor(Math.random() * 24)).padStart(2, '0');
  const minute = String(Math.floor(Math.random() * 60)).padStart(2, '0');
...
// 生成2025.06.19的随机时刻
export const generateRandomTime0619 = () => {
  const hour = String(Math.floor(Math.random() * 24)).padStart(2, '0');
  const minute = String(Math.floor(Math.random() * 60)).padStart(2, '0');
...
// 生成2025.08.27的随机时刻
export const generateRandomTime0827 = () => {
  const hour = String(Math.floor(Math.random() * 24)).padStart(2, '0');
  const minute = String(Math.floor(Math.random() * 60)).padStart(2, '0');
...
// 生成2025.09.18的固定时刻
export const generateFixedTime0918 = () => {
  return `2025.09.18 22:54`;
};

// 生成2025.10.19的固定时刻
export const generateFixedTime1019 = () => {
  return `2025.10.19 01:10`;
};

// 生成2025.11.06的固定时刻
export const generateFixedTime1106 = () => {
  return `2025.11.06 03:42`;
};

// 生成2025.11.09的固定时刻
export const generateFixedTime1109 = () => {
  return `2025.11.09 00:15`;
};

// 生成2025.11.11的固定时刻
export const generateFixedTime1111 = () => {
  return `2025.11.11 02:28`;
};

// 生成2025.12.22的固定时刻
export const generateFixedTime1222 = () => {
  return `2025.12.22 08:14`;
};

// 生成2026.01.11的固定时刻
export const generateFixedTime0111 = () => {
  return `2026.01.11 01:00`;
};

// 生成2025.09.19的固定时刻
export const generateFixedTime0919 = () => {
  return `2025.09.19 01:02`;
};

// 生成2025.05.21的固定时刻
export const generateFixedTime0521 = () => {
  return `2025.05.21 23:56`;
};

// 生成2024.11.18的固定时刻
export const generateFixedTime1118 = () => {
  return `2024.11.18 01:55`;
};

// 生成2024.09.12的固定时刻
export const generateFixedTime0912 = () => {
  return `2024.09.12 12:42`;
};

// 生成2026.03.18的固定时刻
export const generateFixedTime0318 = () => {
  return `2026.03.18 21:30`;
};

// 生成2026.04.17的固定时刻
export const generateFixedTime0417 = () => {
...
// 获取动态星轨数据
export const getDynamicStarMemories = () => {
  // 检查是否在浏览器环境
...
// 添加用户记录到星轨
export const addUserRecordToTrail = (content: string, tags: string[]) => {
  const newRecord = {
...
// 导出STAR_MEMORIES以保持向后兼容
export const STAR_MEMORIES = getDynamicStarMemories();
